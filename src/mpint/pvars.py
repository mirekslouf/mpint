...
mpint.pvars
----------
Package variables = classes for global variables.
"""
...
class peak:
    """
    This class creates peak objects
...
class table_of_results():
    """
    This class creates pandas.DataFrame objects,
    with additional methods for an easy appending of rows and saving.
    """
    ...
    def append_row(self, filename, indexes):
        ...
        Returns
        -------
        self = table_of_results after modification
        """
