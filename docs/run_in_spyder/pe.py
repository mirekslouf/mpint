...
#  * [peaks] = definition of peaks, which are needed to calculate indexes
#  * [calculate_indexes] = definition of indexes, which will be calculated
#  * [x_limits_for_plotting] = definition of limits for plotting spectra
#  * [y_limits_for_plotting] = definition of limits for plotting spectra
